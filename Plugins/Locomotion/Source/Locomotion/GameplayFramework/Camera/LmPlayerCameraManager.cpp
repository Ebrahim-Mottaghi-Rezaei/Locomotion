...
FLmCameraResult ALmPlayerCameraManager::CustomCameraBehaviour() {
	...
	const FRotator rotation = FMath::RInterpTo( GetCameraRotation() ,
	                                            GetOwningPlayerController()->GetControlRotation() ,
	                                            UGameplayStatics::GetWorldDeltaSeconds( this ) ,
	                                            GetCameraBehaviourParam( FName( TEXT( "RotationLagSpeed" ) ) ) );
	...
	const FVector LagSpeeds = FVector( GetCameraBehaviourParam( FName( TEXT( "PivotLagSpeed_X" ) ) ) ,
	                                   GetCameraBehaviourParam( FName( TEXT( "PivotLagSpeed_Y" ) ) ) ,
	                                   GetCameraBehaviourParam( FName( TEXT( "PivotLagSpeed_Z" ) ) ) );
