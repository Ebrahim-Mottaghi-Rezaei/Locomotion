...
void ULmLogger::LogInfo(const FString Message, const float duration) {
	if (GEngine)
...
void ULmLogger::LogWarning(const FString Message, const float duration) {
	if (GEngine)
...
void ULmLogger::LogError(const FString Message, const float duration) {
	if (GEngine)
